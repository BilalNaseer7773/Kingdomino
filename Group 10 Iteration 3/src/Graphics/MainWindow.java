...
public class MainWindow {
    ...
    public void toMenu(int menu, boolean preserveOld){
        MenuController temp = switch (menu) {
            ...
            case LOAD -> new ArchiveController(this, this.controller, ArchiveController.LOAD);
            case SAVE -> new ArchiveController(this, this.controller, ArchiveController.SAVE);
