...
public class PlayerBoxController implements MenuController {
    ...
    public Player getPlayer(){
        Player temp;
        if(ai.isSelected()){
            temp = new ComputerPlayer(nom.getText(), (Sprite) iconSelect.getSelectedItem(), (PlayerColor) colorSelect.getSelectedItem());
        } else{
            temp = new HumanPlayer(nom.getText(), (Sprite) iconSelect.getSelectedItem(), (PlayerColor) colorSelect.getSelectedItem());
        }
        return temp;
    }
}